...
const FlexboxFlexBasic = () => import("../pages/utils/flexbox/FlexBasic.vue")
  ...
  routes: [
    ...
    { path: "/", component: Welcome },
    {
      ...
      children: [
        ...
        { path: "flex-basic", component: FlexboxFlexBasic },
