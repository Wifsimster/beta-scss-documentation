          ...
          <div class="flex flex:wrap">
            <div class="flex:1 px:1/2">
              <div class="border rounded:t:1/2 p:1">
                <div class="relative p:1 bg:grey-light rounded">
                  <div class="rounded bg:grey p:1" :class="`${value.value}:${size}`">
                    ...
                    <br />
                    <br />Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore est at voluptas saepe cumque, similique deserunt modi qui fugit, aspernatur eveniet delectus alias quasi illo quia? Dolor odio esse reiciendis.
                  </div>
                </div>
              </div>
...
export default {
  data() {
    return {
      properties: [
        { label: 'Width', value: 'w' },
        { label: 'Min-width', value: 'min-w' },
        { label: 'Max-width', value: 'max-w' }
      ],
      sizes: [
        '0',
        '1/12',
