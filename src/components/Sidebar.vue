<template>
  <div
    class="bg:black h:screen shadow:large z:10 transition whitespace:no-wrap border:r border:grey-darkest"
  >
    <ul class="list-reset text:white m:0">
      <router-link
        class="px:1 pl:1/2 pr:1 hover:bg:grey-darker hover:text:white cursor:pointer text:grey transition"
        tag="li"
